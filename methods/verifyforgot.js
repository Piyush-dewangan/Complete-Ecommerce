...
module.exports=function(formObj,callback){
      ...
      Messages: [
        {
          ...
          HTMLPart:`<h3>Dear customer,email for forgot password</h3>
          <form action="http://localhost:5000/verifyforgot/${formObj.mailToken}" method="get">
    ...
    request
      .then(result => {
        // console.log("this is result body :",result.body);
